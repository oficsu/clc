...
namespace clc
{
    namespace detail
    {
        ...
        struct numeric_tag { enum { value = Number }; };
        ...
        #define CURIOUS_LOOPHOLED_COUNTER_UP_TO_ONE_SEQUENCE(z, n, data) std::size_t _##n = up_to_one<numeric_tag<0+ BOOST_PP_REPEAT(n, CURIOUS_LOOPHOLED_COUNTER_SUM,)>>(n),
        ...
        template<
            std::size_t _0 = up_to_one<numeric_tag<0>>(1),
